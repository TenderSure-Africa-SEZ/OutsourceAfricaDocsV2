...
3. If a contract is disputed by Management (status `dispute`), you can **Edit Terms** and resubmit, which updates the description, dates, amount, contract file, and payment terms, then sends it back for review.
