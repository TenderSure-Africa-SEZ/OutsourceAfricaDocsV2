...
Every project that Client company has created, with Title, Status, Created By, and Created On. It's a read-only view for context; use the [Projects](reviewing-projects-and-contracts.md) page to actually act on one.
